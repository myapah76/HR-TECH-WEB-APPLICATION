...
VALUES
    ...
    ('60000000-0000-0000-0000-000000000001', NOW(), NOW(), false, '50000000-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 50, 0),    -- Job Posting
    ...
    ('60000000-0000-0000-0000-000000000011', NOW(), NOW(), false, '50000000-0000-0000-0000-000000000002', '11111111-1111-1111-1111-111111111111', 50, 0),    -- Job Posting
...
VALUES
    -- FPT Software HR
    -- Job Posting (usage: 00000001) -> Pro Plan (custom limits for seed to pass CommandLineRunner loop-create of 10 jobs)
    ('70000000-0000-0000-0000-000000000001', NOW(), NOW(), false, '60000000-0000-0000-0000-000000000001', 'DAILY', 15, 0, NOW() - INTERVAL '1 day'),
    ('70000000-0000-0000-0000-000000000002', NOW(), NOW(), false, '60000000-0000-0000-0000-000000000001', 'WEEKLY', 30, 0, NOW() - INTERVAL '1 day'),
    ...
    -- VNG Corporation HR
    -- Job Posting (usage: 00000011) -> Pro Plan (custom limits for seed to pass CommandLineRunner loop-create of 10 jobs)
    ('70000000-0000-0000-0000-000000000011', NOW(), NOW(), false, '60000000-0000-0000-0000-000000000011', 'DAILY', 15, 0, NOW() - INTERVAL '1 day'),
    ('70000000-0000-0000-0000-000000000012', NOW(), NOW(), false, '60000000-0000-0000-0000-000000000011', 'WEEKLY', 30, 0, NOW() - INTERVAL '1 day'),
