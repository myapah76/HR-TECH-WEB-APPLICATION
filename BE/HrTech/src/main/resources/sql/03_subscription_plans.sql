...
VALUES
    -- COMPANY PLANS
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Khởi Đầu', 'Gói trải nghiệm miễn phí cho doanh nghiệp mới', 0, 30, 'COMPANY', true, NOW(), NOW(), false),
    ('cccccccc-cccc-cccc-cccc-cccccccccccc', 'Tiêu Chuẩn', 'Gói tăng trưởng: Mở khóa tìm ứng viên và tính điểm AI', 500000, 30, 'COMPANY', true, NOW(), NOW(), false),
    ('dddddddd-dddd-dddd-dddd-dddddddddddd', 'Chuyên Nghiệp', 'Gói doanh nghiệp: Dành cho nhu cầu tuyển dụng cực lớn', 2000000, 30, 'COMPANY', true, NOW(), NOW(), false),
    -- CANDIDATE PLANS
    ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', 'Cơ Bản', 'Gói miễn phí cho ứng viên tìm việc', 0, 30, 'CANDIDATE', true, NOW(), NOW(), false),
    ('ffffffff-ffff-ffff-ffff-ffffffffffff', 'Cao Cấp', 'Gói thành viên cao cấp: Gợi ý Job & Chatbot', 100000, 30, 'CANDIDATE', true, NOW(), NOW(), false)
...
VALUES
    ...
    ('88888888-8888-8888-8888-888888888884', 'cccccccc-cccc-cccc-cccc-cccccccccccc', '55555555-5555-5555-5555-555555555555', 1, NOW(), NOW()), -- Mở khóa AI Match Scoring
    ...
    ('99999999-9999-9999-9999-999999999993', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '22222222-2222-2222-2222-222222222222', 9999, NOW(), NOW()), -- Candidate Search (Unlimited)
    ('99999999-9999-9999-9999-999999999994', 'dddddddd-dddd-dddd-dddd-dddddddddddd', '55555555-5555-5555-5555-555555555555', 1, NOW(), NOW()), -- Mở khóa AI Match Scoring
    ...
    ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb2', 'ffffffff-ffff-ffff-ffff-ffffffffffff', '66666666-6666-6666-6666-666666666666', 1, NOW(), NOW()) -- Mở khóa Recommend Job
ON CONFLICT (id) DO NOTHING;