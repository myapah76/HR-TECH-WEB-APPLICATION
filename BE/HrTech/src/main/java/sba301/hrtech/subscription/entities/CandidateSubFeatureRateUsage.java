...
@Entity
@Table(
        name = "candidate_sub_feature_rate_usages",
        uniqueConstraints = {
...
@AllArgsConstructor
@Builder
@SQLDelete(sql = "UPDATE candidate_sub_feature_rate_usages SET is_deleted = true WHERE id = ?")
@SQLRestriction("is_deleted = false")
public class CandidateSubFeatureRateUsage extends SoftDeleteEntity {

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "usage_id", nullable = false)
    private CandidateSubFeatureUsage usage;
