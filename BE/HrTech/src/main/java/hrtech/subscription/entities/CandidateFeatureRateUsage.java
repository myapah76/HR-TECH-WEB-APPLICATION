...
@Entity
@Table(
    name = "candidate_feature_rate_usages",
    uniqueConstraints = {
        @UniqueConstraint(columnNames = {"user_id", "feature_id", "reset_type"})
    }
)
@Getter
@Setter
...
@AllArgsConstructor
@Builder
@SQLDelete(sql = "UPDATE candidate_feature_rate_usages SET is_deleted = true WHERE id = ?")
@SQLRestriction("is_deleted = false")
public class CandidateFeatureRateUsage extends SoftDeleteEntity {
