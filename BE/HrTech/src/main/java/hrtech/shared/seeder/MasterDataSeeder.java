...
public class MasterDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        List<JobRequest> mockJobs1 = Arrays.asList(
            createJobRequest("Frontend Developer", "Frontend Developer", "React, Javascript, HTML, CSS", company1.getId(), 15000000, 25000000),
            createJobRequest("Backend Developer", "Backend Developer", "Java, Spring Boot, MySQL, REST API", company1.getId(), 18000000, 35000000),
            createJobRequest("Fullstack Developer", "Backend Developer", "Node.js, React, MongoDB, Express", company1.getId(), 20000000, 45000000),
            createJobRequest("Mobile App Developer", "Mobile Developer", "Flutter, Dart, Firebase, iOS, Android", company1.getId(), 15000000, 30000000),
            createJobRequest("DevOps Engineer", "DevOps Engineer", "Docker, Kubernetes, AWS, CI/CD", company1.getId(), 25000000, 50000000),
            createJobRequest("Data Analyst", "Data Engineer / Analyst", "Python, SQL, Tableau, Excel", company1.getId(), 12000000, 22000000),
            createJobRequest("QA Engineer", "QA Engineer", "Selenium, Cypress, Testing, Automation", company1.getId(), 10000000, 20000000),
            createJobRequest("UI/UX Designer", "UI/UX Designer", "Figma, Sketch, Adobe XD, Design", company1.getId(), 12000000, 25000000),
            createJobRequest("System Administrator", "System Administrator", "Linux, Networking, Bash, Windows Server", company1.getId(), 10000000, 18000000),
            createJobRequest("AI Engineer", "Data Engineer / Analyst", "Python, TensorFlow, PyTorch, Machine Learning", company1.getId(), 30000000, 70000000));

        List<JobRequest> mockJobs2 = Arrays.asList(
            createJobRequest("Senior iOS Developer", "Mobile Developer", "Swift, Objective-C, iOS, Xcode", company2.getId(), 35000000, 60000000),
            createJobRequest("Android Developer", "Mobile Developer", "Kotlin, Java, Android Studio, Mobile", company2.getId(), 15000000, 28000000),
            createJobRequest("Backend Engineer", "Backend Developer", "Golang, PostgreSQL, Redis, Microservices", company2.getId(), 20000000, 40000000),
            createJobRequest("Frontend Engineer", "Frontend Developer", "Vue.js, Javascript, Tailwind, CSS", company2.getId(), 12000000, 22000000),
            createJobRequest("Cloud Architect", "DevOps Engineer", "Azure, AWS, Architecture, System Design", company2.getId(), 45000000, 90000000),
            createJobRequest("Machine Learning Engineer", "Data Engineer / Analyst", "Python, Scikit-Learn, Keras, Data Science", company2.getId(), 35000000, 65000000),
            createJobRequest("Database Administrator", "Backend Developer", "Oracle, SQL Server, MySQL, Performance Tuning", company2.getId(), 18000000, 32000000),
            createJobRequest("Security Engineer", "DevOps Engineer", "Cybersecurity, Penetration Testing, OWASP", company2.getId(), 22000000, 45000000),
            createJobRequest("Product Manager", "Business Analyst / PM", "Agile, Scrum, Leadership, Product Strategy", company2.getId(), 25000000, 50000000),
            createJobRequest("Data Scientist", "Data Engineer / Analyst", "Python, Rlang, Statistics, Data Mining", company2.getId(), 30000000, 60000000));
