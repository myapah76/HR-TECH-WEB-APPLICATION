...
public class AiServiceClient {
    ...
    public MapRelationshipsResponseDto mapRelationships(List<String> newSkills, List<String> dbSkills,
        ...
        try {
            ...
            log.info("Sending {} new skills and {} db skills to AI Service for relationship mapping",
                    newSkills.size(), dbSkills != null ? dbSkills.size() : 0);
    ...
    public boolean isAvailable() {
        try {
            ResponseEntity<Void> response = restTemplate.getForEntity(aiServiceUrl + "/", Void.class);
    ...
    public AiMatchingAdviceResponseDto getMatchingAdvice(String cvText, String jdText, List<String> missingSkills) {
        ...
        try {
            ...
            log.info("Sending candidate matching advice request to AI Service for {} missing skills",
                    missingSkills.size());
            HttpEntity<Map<String, Object>> entity = new HttpEntity<>(requestBody, headers);
    ...
    public ValidateSkillsResponse validateSkills(List<String> skills) {
        ...
        try {
            ...
            ResponseEntity<ValidateSkillsResponse> response = restTemplate.postForEntity(url, request,
                    ValidateSkillsResponse.class);
            return response.getBody();
        } catch (Exception e) {
