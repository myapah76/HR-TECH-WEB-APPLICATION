...
export default function PromoBanners({}: PromoBannersProps) {
  return (
    <section className="bg-transparent py-12" id="promotional-banners-section">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6" id="promo-grid">
          ...
          <div 
            className="relative h-[280px] sm:h-[340px] rounded-3xl overflow-hidden shadow-xl group cursor-pointer border border-slate-100 hover:shadow-2xl hover:shadow-emerald-900/10 transition-all duration-300"
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-teal-950/85 via-teal-900/40 to-transparent z-10"></div>
          ...
          <div 
            className="relative h-[280px] sm:h-[340px] rounded-3xl overflow-hidden shadow-xl group cursor-pointer border border-slate-100 hover:shadow-2xl hover:shadow-rose-900/10 transition-all duration-300"
          ...
          >
            ...
            <img 
              ...
              className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-105"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-rose-950/90 via-rose-900/40 to-transparent z-10"></div>
            ...
            <div className="absolute bottom-6 right-6 h-12 w-12 bg-white rounded-full flex items-center justify-center shadow-lg z-20 border border-rose-100 hidden sm:flex">
