...
import { ArrowRight, Globe, Layers, MapPin, Landmark } from 'lucide-react';

interface TalentNetworkProps {
  }

export default function TalentNetwork({}: TalentNetworkProps) {
  const partners = [
    {
      id: "part-1",
      title: "Hệ Thống Đào Tạo Nexus",
      image: "https://images.unsplash.com/photo-1573497491208-6b1acb260532?auto=format&fit=crop&w=350&q=80",
      description: "Nâng cao giá trị chuyên môn thông qua các khóa huấn luyện tiêu chuẩn."
    },
    {
      id: "part-2",
      title: "VietTravel Partner",
      image: "https://images.unsplash.com/photo-1548574505-5e239809ee19?auto=format&fit=crop&w=350&q=80",
      description: "Thư giãn nghỉ mát hàng đầu dành cho doanh nghiệp thành viên."
    },
    {
      id: "part-3",
      title: "FIT HR Agency",
      image: "https://images.unsplash.com/photo-1557804506-669a67965ba0?auto=format&fit=crop&w=350&q=80",
      description: "Kết nối việc làm cấp cao thông qua mạng lưới chuyên viên săn nhân tài."
    },
    {
      id: "part-4",
      title: "IDG Ventures",
      image: "https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=350&q=80",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10 max-w-3xl" id="talent-network-header">
          ...
          <p className="text-sm font-semibold text-gray-500 mt-1">
            {'khi kết nối cùng các công ty hàng đầu tại '}<span className="text-blue-600 font-bold">TalentNetwork</span>
          </p>
        </div>

        {/* 2-Column Split: Map on Left, Partner Grid on Right */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center" id="talent-network-grid">
          
          {/* LEFT COLUMN: Map of Global Network */}
          <div className="lg:col-span-5 relative" id="talent-network-map-col">
            <div className="overflow-hidden rounded-2xl border border-gray-150 shadow-md aspect-[4/3] bg-gradient-to-br from-amber-50/50 to-orange-50/20 group">
              <img 
                src="https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=800&q=80" 
                alt="TalentNetwork World Globe"
                referrerPolicy="no-referrer"
                className="w-full h-full object-cover filter grayscale hover:grayscale-0 contrast-125 transition-all duration-700 group-hover:scale-102"
              />
              {/* Overlay details */}
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-gray-900/90 p-5 text-white">
                <div className="flex items-center gap-2 mb-1">
                  <Globe className="h-4 w-4 text-amber-400" />
                  <p className="text-[10px] uppercase font-bold tracking-wider text-amber-400">{'Toàn cầu đạt chuẩn quốc tế'}</p>
                </div>
