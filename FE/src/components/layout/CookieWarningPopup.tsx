...
export function CookieWarningPopup() {
  ...
  const handleAllowClick = () => {
    ...
    alert(
      'Trình duyệt của bạn đang chặn Cookie. Vui lòng mở Cài đặt (Settings) của trình duyệt bạn đang dùng (Chrome, Edge, Safari...), tìm mục Quyền riêng tư/Cookie (Privacy/Cookies) và cho phép lưu Cookie, sau đó F5 tải lại trang.'
    )
  }
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex-1">
          <h3 className="font-semibold text-slate-900 mb-1">
            Cảnh báo: Trình duyệt đang chặn Cookie
          </h3>
          <p className="text-sm text-slate-600">
            Ứng dụng cần sử dụng Cookie để duy trì trạng thái đăng nhập bảo mật của bạn. Hiện tại hệ
            thống đang chạy ở chế độ dự phòng (bạn sẽ bị đăng xuất nếu tải lại trang hoặc tắt Cookie
            hoàn toàn).
          </p>
        </div>
